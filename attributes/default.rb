...
default[:wof][:spelunker][:gunicorn][:pid] = '/var/run/spelunker.pid'
default[:wof][:spelunker][:gunicorn][:socket][:dir] = '/var/run'
default[:wof][:spelunker][:gunicorn][:socket][:path] = '/var/run/spelunker.socket'
